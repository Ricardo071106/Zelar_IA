  ...
  return (
    <header
      className={`fixed w-full z-50 transition-all duration-300 ${
        scrolled
          ? "bg-white/90 backdrop-blur-md shadow-sm border-b border-emerald-200/60"
          : "bg-white/80 backdrop-blur-sm border-b border-emerald-100/50"
      }`}
    >
      ...
      <div className={`md:hidden bg-white/95 border-b border-emerald-100 pb-4 px-4 ${mobileMenuOpen ? "block" : "hidden"}`}>
